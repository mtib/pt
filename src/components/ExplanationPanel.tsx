...
export const ExplanationPanel: React.FC<ExplanationPanelProps> = ({
  ...
  return (
    <div className={`bg-neutral-800 text-neutral-100 p-4 overflow-y-auto ${className}`}>
      <article>
        {/* Word Header */}
        <header className="mb-6">
          ...
          <div className="text-neutral-400 text-sm">
            ...
            {explanation.pronunciationEnglish && (
              <span className="ml-2">({explanation.pronunciationEnglish})</span>
            )}
          </div>
        </header>
        ...
        <div className="space-y-6">
          ...
          {explanation.example && (
            <section>
              ...
              <div className="bg-neutral-900 p-3 rounded border-l-4 border-blue-500">
          ...
          {explanation.definition && (
            <section>
              ...
              <div className="bg-neutral-900 p-3 rounded border-l-4 border-green-500">
                <pre className="text-sm whitespace-pre-wrap text-neutral-200">
                  {explanation.definition}
                </pre>
              </div>
          ...
          {explanation.explanation && (
            <section>
              ...
              <div className="bg-neutral-900 p-3 rounded border-l-4 border-yellow-500">
                <pre className="text-sm whitespace-pre-wrap text-neutral-200">
                  {explanation.explanation}
                </pre>
              </div>
          ...
          {explanation.grammar && (
            <section>
              ...
              <div className="bg-neutral-900 p-3 rounded border-l-4 border-purple-500">
                <pre className="text-sm whitespace-pre-wrap text-neutral-200">
                  {explanation.grammar}
                </pre>
              </div>
          ...
          {explanation.facts && (
            <section>
              ...
              <div className="bg-neutral-900 p-3 rounded border-l-4 border-orange-500">
                <pre className="text-sm whitespace-pre-wrap text-neutral-200">
                  {explanation.facts}
                </pre>
              </div>
