...
export const QuizInterface: React.FC = () => {
    ...
    return (
        <div className='wide:flex-grow'>
            <div className='pt-3 px-3 flex justify-between items-start'>
                <div className="inline p-1 dark:bg-neutral-800 dark:text-neutral-400 bg-neutral-200 text-neutral-700 rounded">
                ...
                <button
                    ...
                    className="p-2 rounded-full bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-400 hover:bg-neutral-300 dark:hover:bg-neutral-700 transition-colors"
                    title="Settings"
